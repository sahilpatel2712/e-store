...
const CancelModal = ({ modal, toggle, handleCancel }) => {
  ...
  return (
    <div>
      <Modal isOpen={modal} toggle={toggle}>
        <ModalHeader toggle={toggle}>Cancel Order Confirmation</ModalHeader>
        <ModalBody className="d-flex justify-content-center">
          Are you sure you want to cancel your order? This action cannot be
          undone. By canceling your order, you will lose your reservation on the
          selected items.
        </ModalBody>
        <ModalFooter>
          <Button color="danger" onClick={handleCancelModal}>Cancel Order</Button>
        </ModalFooter>
      </Modal>
    </div>
  );
...
const OrderDetails = ({ order }) => {
  ...
  return (
    ...
    >
      <CancelModal modal={modal} toggle={toggle2} handleCancel={handleCancel} />
